...
def my_NME_image(pts_pred, pts_true):
    # size: pts_pred and pts_true 68x2
    nme = 0
    N = 68
...
def Dlib_Model(path_imagen,method):
    ...
    if method==1:
        ...
        #keypoints, images = net.apps.detect_facial_keypoints(path_imagen, plot_enabled = True, figsizeScale = 1.5)
